/*===========================================================================================================
filename			:	tidyUp_uniVarBinConOrd_ACEorADE_replace.sas
modified from	:	rename_variables_list.sas
author				:	Chang, LH
modified from	:
date created		:	20170528
path					: 	
purpose			:	tidy up modelling result from univariate ACE or ADE using OpenMx
							replace tidyUp_uniVarBinConOrd_ACEorADE.sas
...
%macro prettify_uniVar_ACEorADE(ACEorADE=, inFile=,outFile=);
    ...
    %if &ACEorADE. = ACE %then
        %do;			
			retain method depVar comparison2 mxStatusCode A Alb Aub A_CI CorD_CI E_CI ep df diffdf minus2LL diffLL AIC p; 
